...
public class DueFee extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<link rel='stylesheet' href='/FeeManagementBootstrap/WebContent/Resources/bootstrap.min.css'/>");
		out.println("<link rel='stylesheet' href='/FeeManagementBootstrap/WebContent/style.css'/>");
		out.println("</head>");
		out.println("<body>");
